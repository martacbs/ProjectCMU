...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE events (id INTEGER PRIMARY KEY AUTOINCREMENT, nomeEvento VARCHAR(50) NOT NULL, localEvento VARCHAR(50) NOT NULL, data VARCHAR(50) NOT NULL, comeca TIME NOT NULL, duracao INTEGER(50) NOT NULL, lembrete VARCHAR(50) NOT NULL)");
